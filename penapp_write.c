...
{
    static uint32_t tag = 0x00000155;
    uint8_t cdb_len;
    int i, r, size;
...
int main(void)
{
    ...
    send_mass_storage_command(handle, 0x01, 0, cdb, /*(0x01 | LIBUSB_ENDPOINT_OUT) */ 0x00, 512, &expected_tag);

    char string1[512] ={0};
    char string2[512] ={0};
     strcpy(string1, "abcdefghxxxxtest write into usb mass storage using libusb");   
    int transferred = 0, i;
